...
export class DepositPage{
    ...
    readonly phantomDepositBtnn: Locator
    ...
    constructor (page:Page){
        ...
        this.phantomDepositBtnn = this.page.locator('div').filter({ hasText: /^Deposit Amount \(After Fees\)0\.00000 USDC\$0\.00000Deposit$/ }).getByRole('button')
